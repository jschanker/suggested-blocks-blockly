...
import trainingDataExamples from 'training-data-db.json'
import * as NaiveBayes from '../src/NaiveBayesClassifier';
/**
 * Create a workspace.
...
const trainingData = JSON.parse(trainingDataExamples)
